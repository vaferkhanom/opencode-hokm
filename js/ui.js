(function (root) {
  ...
  const UI = {
    ...
    buildMenu: function (stats) {
      ...
      wrap.appendChild(el('footer', 'menu-foot', 'مخصوص تلگرام · فارسی · آفلاین'));
      scr.appendChild(fan);
    ...
    rulesModal: function () {
      const tabs = {
        four: '<ul class="rules-list">' +
          ...
          '<li><b>پخش:</b> ۵–۴–۴؛ دسته را یارِ حاکم کوپ می‌کند. حاکم فقط با ۵ کارت اولش خال حکم را اعلام می‌کند.</li>' +
        ...
        two: '<ul class="rules-list">' +
          ...
          '<li><b>برداشت:</b> نوبتی از برگهٔ ۴۲تایی: کارت اول را ببین — نگه دار یا رد کن. اگر رد کنی، دومی اجباری است. اگر نگه داری، دومی دور ریخته می‌شود. تا ۱۳ کارت.</li>' +
